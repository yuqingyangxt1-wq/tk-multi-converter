@echo off
REM ============================================================
REM   TK Multi Converter - SIMPLE build (just double-click)
REM   No admin check, no chcp, no fanciness - just works.
REM ============================================================

REM Locate tk-multi-converter folder automatically.
REM This file should be inside the tk-multi-converter folder.
cd /d "%~dp0"
...
echo.
echo ============================================================
echo  TK Multi Converter - Simple Build
echo  Current dir: %CD%
echo ============================================================
